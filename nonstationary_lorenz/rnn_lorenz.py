...
if __name__ == '__main__':
    ...
    n_intervals = 10 # number of intervals in each training example
    ...
    # Train on 4 full trajectories and test on one full trajectory
    ...
    # model
    model = GRU_net(in_dim = T*dim, out_dim = T*dim, hidden_units = hidden_units, num_layers = num_layers).cuda()
