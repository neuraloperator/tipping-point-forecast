...
class L63:
  ...
  def get_inits_off_attractor(_s):
...
#     ('b', one-arg function from t to float32),      # a time-dependent scalar field
...
class L63_time_dep:
  ...
  A simple class that implements Lorenz 63 model, with time-dependent parameters.
  By default constant Lorenz-63 canonical parameters are used. 
  ...
  def __init__(_s, a = lambda t: 10, b = lambda t: 28, c = lambda t: 8/3):
    '''
    Initialize an instance: setting parameters and xkstar
    '''
    _s.a = a
  ...
  def rhs(_s, S, t):
    ...
    foo_rhs[0] = -a(t)*x + a(t)*y
    foo_rhs[1] = b(t)*x - y - x*z
    foo_rhs[2] = -c(t)*z + x*y
