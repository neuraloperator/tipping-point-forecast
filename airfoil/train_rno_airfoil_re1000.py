...
if __name__ == '__main__':
    ...
    path = 'RNO_airfoil_div_corrected_normalization_fixed_re1000_multi_step' + str(multi_step_num_steps) + '_N' +str(ntrain) + '_ep' + str(multi_step_ep) + '_1m' + str(modes1) + '_2m' + str(modes2) + '_w' + str(width) + 'domain_trunc' + \
